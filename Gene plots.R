...
labs1 <- ifelse(chrom$Gene %in% 
                  c(chrom[grepl("CHS3", chrom$Clustering), "Gene"][c(1:6,8,9)], 
                    ...
                    chrom[grepl("TTR1", chrom$Clustering), "Gene"][c(1,2,4,6,7,9,11,13,15,16,18)],
                    ...
                    chrom[grepl("SSI4", chrom$Clustering), "Gene"],
                    chrom[grepl("RPS6", chrom$Clustering), "Gene"]), chrom$Gene, "")

labs2 <- ifelse(!chrom$Gene %in%
                  c(chrom[grepl("CHS3", chrom$Clustering), "Gene"][c(7)],
                    chrom[grepl("RSG2", chrom$Clustering), "Gene"][c(2)],
                    chrom[grepl("TTR1", chrom$Clustering), "Gene"][c(3,5,8,10,12,14,17,19)],
                    chrom[grepl("AT5G48770", chrom$Clustering), "Gene"][c(2)]), "",chrom$Gene)
...
ggsave("Graphs\\Gene plots\\chrom5 clusters.png", plot = plot, width = 20, height = 16)